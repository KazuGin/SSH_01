...
public class TestMP {
    ...
    private static String author ="梁和营";//作者名称
    private static String outputDir ="E:\\";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/db_bills?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    private static String username ="root";//数据库用户名
    private static String password ="root";//数据库密码
    private static String tablePrefix ="t_";//数据库表的前缀，如t_user
    private static String [] tables = {"user","bills","billtype"};	//生成的表
    private static String parentPackage = "com.bdqn.bills";//顶级包结构
